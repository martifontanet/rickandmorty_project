...
const EpisodesFilter = ({ onSeasonChange }) => {
  ...
  const handleSeasonChange = (e) => {
    ...
    onSeasonChange(season); // Llamamos al callback para enviar el valor de la temporada seleccionada
  };
  ...
  return (
    <div className="epfilter">
      ...
      <select name="cars" id="seasons" className='button shortButton' onChange={handleSeasonChange}>
        <option value="nothing"></option> {/* El usuario decide por cual temporada quiere filtrar */}
        <option id="s01" value="s01">Season 1</option>{/* Ponemos de valor la url que necesitamos para la api */}
